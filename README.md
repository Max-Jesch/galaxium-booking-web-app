...
- [Galaxium Travels Infrastructure](https://github.com/Max-Jesch/galaxium-travels-infrastructure) - Main infrastructure repository with booking system backend and other services
